...
filepath = 'c:\\Python\\Script_Pictures\\moduleTest\\Screenshots\\Unit2\\%s' %currentDay
if not os.path.exists(filepath):
	os.makedirs('c:\\Python\\Script_Pictures\\moduleTest\\Screenshots\\Unit2\\%s' %currentDay)
...
def injectModule(moduleName):
	...
	sleep(moduleDataUnit2[moduleName][0])
	btnPos.click_ContinueBtn(moduleDataUnit2[moduleName][1])
	if moduleDataUnit2[moduleName][2] == True:
