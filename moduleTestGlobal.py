...
filepath = 'c:\\Python\\Script_Pictures\\moduleTest\\Screenshots\\moduleDataGlobal\\%s' %currentDay
if not os.path.exists(filepath):
	os.makedirs('c:\\Python\\Script_Pictures\\moduleTest\\Screenshots\\moduleDataGlobal\\%s' %currentDay)
...
def Screenshot_with_Paint(name):
	...
	sleep(15)
	pyautogui.typewrite('c:\\Python\\Script_Pictures\\moduleTest\\Screenshots\\moduleDataGlobal\\')
	sleep(1)
...
def injectModule(moduleName):
	...
	sleep(moduleDataGlobal[moduleName][0])
	btnPos.click_ContinueBtn(moduleDataGlobal[moduleName][1])
	if moduleDataGlobal[moduleName][2] == True:
...
for module in moduleDataGlobal:
	injectModule(module)
