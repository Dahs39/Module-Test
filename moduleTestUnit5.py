...
filepath = 'c:\\Python\\Script_Pictures\\moduleTest\\Screenshots\\Unit5\\%s' %currentDay
if not os.path.exists(filepath):
	os.makedirs('c:\\Python\\Script_Pictures\\moduleTest\\Screenshots\\Unit5\\%s' %currentDay)
...
def injectModule(moduleName):
	...
	sleep(moduleDataUnit5[moduleName][0])
	btnPos.click_ContinueBtn(moduleDataUnit5[moduleName][1])
	if moduleDataUnit5[moduleName][2] == True:
